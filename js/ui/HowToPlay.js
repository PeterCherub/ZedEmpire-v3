...
const PAGES = [
  ...
  },
  {
    ...
    lines: [
      ...
      'Each loss is a SETBACK: you start over from Chapter 1 with fresh stats, but your Bank savings carry over. Your loss count keeps climbing across every restart.',
      'Every 3rd loss, robbers catch up with you and empty your Bank savings to K0 before you start over again -- losses 1, 2, 4, 5, 7, 8 and so on leave your savings untouched.',
