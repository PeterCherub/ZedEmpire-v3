...
export class Settings {
  constructor(W) {
    ...
    by += BTN_H + GAP;
    this.playerNameBtn = new Button(bx, by, BTN_W, BTN_H, "PLAYER NAME", { color: theme.panel, textColor: theme.gold });
    by += BTN_H + GAP;
  ...
  buttons() {
    return [this.panel.closeBtn, this.quitBtn, this.resetBtn, this.menuBtn, this.soundBtn, this.howToPlayBtn, this.playerNameBtn, this.feedbackBtn];
  }
  ...
  mousepressed(x, y) {
    ...
    if (this.playerNameBtn.click(x, y)) {
      return "playerName";
    }
